...
interface Props<T extends ElementType, D> {
...
export default function ManitoCard<T extends ElementType, D>({
  ...
  const classNameValue = twMerge(
    "rounded-xl w-full transition duration-300 transform border border-gray-300 sm:scale-100 scale-[0.8] sm:hover:scale-105ac hover:shadow-lg dark:border-gray-200/50",
    className
  );
