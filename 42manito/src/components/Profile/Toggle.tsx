    ...
    <div className="items-center justify-center flex flex-row mb-5">
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        <input
          ...
          checked={!isHide}
        ></input>
        <div className="w-11 h-6 bg-bg_color-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-300 dark:peer-focus:ring-pink-800 rounded-full peer dark:bg-bg_color-700 peer-checked:after:tranbg_color-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-bg_color-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-bg_color-600 peer-checked:bg-pink-600"></div>
      </label>
    </div>
  );
}
