  ...
  return (
    <div className=" flex flex-col min-h-[80vh] p-5 items-start justify-center text-4xl sm:text-5xl lg:text-7xl font-bold md:mx-0">
      <div className="mt-16">
        ...
        >
          <span className="text-4xl sm:text-5xl lg:text-7xl text-bg_color-800 dark:text-bg_color-200">
            {"내 "}
          </span>
      ...
      <div className="my-16">
        ...
        >
          <span className="text-2xl sm:text-3xl lg:text-5xl text-bg_color-800 dark:text-bg_color-200">
            {"지금 바로 멘토링 "}
          </span>
          <span className="text-3xl sm:text-4xl lg:text-6xl text-indigo-600">
            {"신청"}
          </span>
          <span className="text-2xl sm:text-3xl lg:text-5xl text-bg_color-800 dark:text-bg_color-200 mr-10">
            {"하세요!"}
          </span>
        </TypeIt>
      </div>
